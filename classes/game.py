...
class Person:
    ...
    def choose_items(self):
        ...
        for item in self.items:
            print("    ", str(i) + ":", item['item'].name, "( cost :", str(item['item'].description) + "(x"+str(item['quantity'])+")")
            i += 1
    ...
    def get_stat(self):
        ...
        print(bcolors.BOLD+self.name+":"+"| "+current_hp+bcolors.OKGREEN+"  |"+hp_bar+"|"+bcolors.ENDC+current_mp+bcolors.OKBLUE+"|"+mp_bar+"|"+bcolors.ENDC)
